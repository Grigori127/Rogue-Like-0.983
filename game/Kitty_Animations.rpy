...
image Kitty_Sprite:        
    LiveComposite(
        ...
        (0,0), ConditionSwitch(                                                                        
            ...
            "not Kitty_Arms and K_DynamicTan[0] and K_DynamicTan[3] == 'white cami'", AlphaMask("images/KittySprite/Kitty_Sprite_Arms1.png", "images/KittySprite/Kitty_Sprite_WhiteCami1.png"),
